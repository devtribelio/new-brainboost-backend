...
module.exports = {
  apps: [
    ...
    },
    {
      ...
      args: 'affiliatePendingToBalance expirePendingPayments refreshAffiliateLeaderboard sweepOrphanUploads purgeScheduledDeletions topicDigest streakReminder',
      exec_mode: 'fork',
      instances: 1,
      autorestart: false,
