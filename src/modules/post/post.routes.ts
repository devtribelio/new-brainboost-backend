...
export function postRoutes(): Router {
  ...
  bindRoute({ router, controller: ctrl, method: 'get', path: '/post/list', handlerKey: 'list', middlewares: [optionalAuthGuard] });
  bindRoute({ router, controller: ctrl, method: 'get', path: '/post/detail', handlerKey: 'detail', middlewares: [optionalAuthGuard] });
